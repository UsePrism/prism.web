        ...
        <div className="mb-[28px]">
          ...
          <div className="my-[24px]">
            ...
            <p>
              ...
              cookie could store your account preferences and other information
              to help make our Services more customized.
            </p>
          </div>
          ...
          <div className="my-[24px]">
            ...
            <p>
              ...
              tracking URLs, to identify users on https://www.useprism.co/ (the
              “Site”) and collect information about how you or others access or
              engage with our Services, content, emails, and ads displayed on or
              off our Services. Cookies may also be used by other third-party
              websites where you access third-party links. Cookies enable us to
              make your user experience easier, customise our features and
              services, content and advertising; help you ensure that your
              account security is not compromised, mitigate risk and prevent
              fraud; and to promote trust and safety.
            </p>
            <p className="my-[10px]">
          ...
          <div className="my-[24px]">
            ...
            <div className="my-[10px]">
              <p>
                <span className="font-[600]">Strictly necessary Cookies: </span>
                these are cookies that are required for the operation of our
                Site. They include, for example, cookies that enable you to
                visit the Site and make use of any of the features and services.{" "}
              </p>
            </div>
            ...
            <div className="my-[10px]">
              <p>
                ...
                visits to the Site and to see how users and visitors move around
                the Site when it is being used. This helps us to improve the way
                the Site works by ensuring that users can easily access our
            ...
            <div className="my-[10px]">
              <p>
                ...
                these are used to recognize you when you return to the Website.
                This enables us to personalize your experience and remember your
                preferences and the choices you make on the Site.
              </p>
            </div>
            ...
            <div className="my-[10px]">
              <p>
                ...
                these cookies record your visit to the Site, the pages you have
          ...
          <div className="my-[24px]">
            ...
            <p className="my-[10px]">
              ...
              have settings that enable you to decline or delete Cookies on your
              device or alert you when a site wants to place a cookie on your
              computer. Please note that if you decline Cookies, you may not be
              able to sign in, customize, or use some of the interactive
              features of our Services, as some of our Services require Cookies
              to operate.
            </p>
